...
class KeySchedule{
   ...
   */
   private static String pc_2(String input){
       StringBuilder permutedString = new StringBuilder();
       // loop through rows and cols of fixed 2d array
       for(int i = 0; i < 6; i ++) {
           for(int j = 0; j < 8; j++) {
               permutedString.append(input.charAt(PC_2[i][j]-1));
           }
       }
       return permutedString.toString();
   }
   ...
   */
   static String[] generateSubkeysForDecryption(String key){
    ...
    /**
     ...
     @return an array of 16 subkeys
     */
    static String[] generateSubkeysForEncryption(String key){
        String[] subkeys = new String[16];
        String firstOutput = pc_1(key);
        String c = firstOutput.substring(0, 28);
        String d = firstOutput.substring(28);
